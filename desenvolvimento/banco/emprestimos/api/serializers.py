...
from emprestimos.models import SimulacaoEmprestimo #nosso model que criamos anteriormente
...
class SimulacaoEmprestimoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        def save(self, **kwargs):
            ...
            #construtor de simulação de emprestimo
            simulacaoEmpObj = SimulacaoEmprestimo(id=id,valor_emprestimo=valor_emprestimo, taxa_juros=taxa_juros,prazo_meses=prazo_meses)
